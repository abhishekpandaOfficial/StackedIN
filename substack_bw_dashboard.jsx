  ...
  return <div className="stackedin-site">
    ...
    <main id="top">
      ...
      <section className="community-scenes" aria-label="Knowledge in motion">
        ...
        <div className="community-scenes-grid">
          <figure className="scene-collaborate"><img loading="lazy" src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=900&q=90" alt="Professionals collaborating around a table" /><figcaption><span>01 · Collaborate</span><strong>Ideas sharpen in good company.</strong><small>Shared context · Trusted peers</small></figcaption></figure>
          <figure className="scene-build"><img loading="lazy" src="https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=760&q=90" alt="A team discussing ideas in a bright workspace" /><figcaption><span>02 · Build</span><strong>Make the work visible.</strong><small>Projects · Systems · Proof</small></figcaption></figure>
          <figure className="scene-explain"><img loading="lazy" src="https://images.unsplash.com/photo-1556761175-b413da4baf72?w=760&q=90" alt="Professionals explaining work during a meeting" /><figcaption><span>03 · Explain</span><strong>Clarity becomes authority.</strong><small>Articles · Notes · Discussions</small></figcaption></figure>
          <figure className="scene-connect"><img loading="lazy" src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=760&q=90" alt="People learning and connecting around a laptop" /><figcaption><span>04 · Connect</span><strong>Meet through shared intent.</strong><small>Interests · Skills · Context</small></figcaption></figure>
          <figure className="scene-share"><img loading="lazy" src="https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=760&q=90" alt="A professional sharing from a mobile device" /><figcaption><span>05 · Share</span><strong>Your signal travels intact.</strong><small>Feed · Profile · XStudio</small></figcaption></figure>
          <article className="scene-signal-card"><div><BrainCircuit size={18} /><span>Knowledge graph</span></div><strong>Work becomes a connected professional story.</strong><p>Every project, article, skill, and conversation adds context—not clutter.</p><footer><span>Signal</span><i><em /></i><b>Compounding</b></footer></article>
        </div>
      </section>
