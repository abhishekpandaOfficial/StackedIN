    ...
    <main className="careeros-landing">
      <header className="careeros-nav" aria-label="CareerOS navigation">
        ...
        <div className="careeros-nav__actions">
          ...
          <a className="careeros-primary" href="#career-audit">Start 24-hour audit <ArrowRight size={16} /></a>
        </div>
      </header>
      ...
      <section className="careeros-hero" aria-label="CareerOS global career agent">
        ...
        <div className="careeros-hero__content">
          ...
          <p>
            CareerOS continuously discovers, qualifies and prepares global opportunities around your verified CV, technical stack, salary, target countries and relocation preferences.
          </p>
          <div className="careeros-hero__actions">
            <a className="careeros-primary careeros-primary--large" href="#career-audit">Start free for 24 hours <ArrowRight size={17} /></a>
            <a className="careeros-secondary" href="#how-it-works">See how the agent works</a>
          </div>
          <div className="careeros-proof" aria-label="CareerOS capabilities">
      ...
      <section className="careeros-intro" id="how-it-works">
        <div>
          <span className="careeros-eyebrow">01 · Candidate intelligence</span>
          <h2>One private career graph. Every decision grounded in evidence.</h2>
        </div>
        <p>
          Upload or sync your CV, verify your experience and skills, select countries and roles, define salary and relocation constraints, then choose how much control the agent receives.
        </p>
      </section>

      <section className="careeros-flow" aria-label="CareerOS workflow">
        {["Profile", "Discover", "Visa", "Match", "Salary", "Tailor", "Approve", "Apply", "Track", "AEON"].map((step, index) => (
          <article key={step}>
      ...
      <section className="careeros-audit" id="career-audit">
        <div>
          <span className="careeros-eyebrow">24-hour Global Career Audit</span>
          <h2>See what CareerOS understands before you subscribe.</h2>
          <p>Get candidate profiling, country intelligence, job matching, visa and salary analysis, one tailored CV and an AEON readiness assessment.</p>
        </div>
        <div className="careeros-price-card">
          <span>StackedIN Premium</span>
          <strong>₹500 <small>/ month</small></strong>
          <p>or ₹5,000 billed annually.</p>
          <button type="button">Create CareerOS workspace <ArrowRight size={16} /></button>
